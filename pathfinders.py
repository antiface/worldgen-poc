...
# hundredth_manhattan: 0.01 * grid distance between two points
def hundredth_manhattan_distance(p1, p2):
	return 0.01*(abs(p1[0]-p2[0]) + abs(p1[1]-p2[1]))
...
heuristic_fns = {
	...
	'hundredth_manhattan': hundredth_manhattan_distance,
